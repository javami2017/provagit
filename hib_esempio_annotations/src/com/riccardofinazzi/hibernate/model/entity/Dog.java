...
@Entity
// @Table(name="") /* No need as the class name and db table have a matching name*/
public class Dog {
	...
	@Column
	// @Column(name="") /* No need as field's name and db column have a matching name */
	private String name;

	@ManyToOne /* An owner can have many dogs */
	/* The connecting (join) table that will hold the owner's id and the foreign key name */
